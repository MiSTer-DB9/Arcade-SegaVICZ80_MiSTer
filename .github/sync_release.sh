...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-SegaVICZ80_MiSTer.git"
CORE_NAME=(Arcade-SegaVICZ80)
...
UPSTREAM_CORE_NAME=(Arcade-SegaVICZ80)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-SegaVICZ80.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-SegaVICZ80.rbf)
